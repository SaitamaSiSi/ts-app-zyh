...
export default {
    ...
    setup() {
        ...
        const productTypeOption = ref(['默认品类', '牛肉品类', '鸡肉品类', '猪肉品类']);
        ...
        function loadingMoreProduct() {
            productList.value.push({
                ...
                checked: false,
                name: '产品1',
                comment: '产品1的描述XXXXXXXXXXXXXXXXXXXXXXc好滴哦娃都会哦啊我第几啊我i骄傲我i多久啊我哦i大',
                type: '款式1',
                price: 20,
                url: '/static/logo.png',
                num: 1,
    ...
    <view class="container">
        <view class="page-header">
            ...
            <view class="uni-margin-wrap">
                <swiper class="swiper" :circular="true" :indicator-dots="swiperProps.showDot"
                    :autoplay="swiperProps.autoPlay" :interval="swiperProps.interval" :duration="swiperProps.duration">
                    <swiper-item v-for="(item, index) in swiperItems" :key="index" @click="clickSwiper(item)">
        ...
        <view class="page-container">
            ...
            <CompProductList :productList="productList" @handle-click="handleProductClick"
                @handle-add="handleProductAdd" />
            <view class="page-bottom">
                <CompLoading class="page-loading" :style="{display: `${showLoading ? '' : 'none'}`}" />
            </view>
        </view>
    </view>
</template>
